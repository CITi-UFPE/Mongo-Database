...
from routers import gemini # Importa o seu arquivo novo

# E lá embaixo, junto com as outras rotas:
...
#rota do gemini (CORREÇÃO DO ERRO 404)
app.include_router(gemini.router, prefix="/api/gemini", tags=["Chat IA"])
# 4. Gemini IA
